...
const publications = () => (
    <ol reversed>
        ...
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/tdsc_2020.pdf")}> [PDF]</a></em></div>
        </li>
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/icdcs_2020.pdf")}> [PDF]</a> (to be appeared)
        ...
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/ddift_2019.pdf")}> [PDF]</a></em></div> 
        </li>
        <li className="text-left li_padding_bottom">
            ...
            <div><em>Arxiv Preprint arXiv:1712.01145<a href={require("../Downloads/paper/propedeutica_2018.pdf")}> [PDF]</a> </em></div>
        </li>
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/dsc_2017.pdf")}> [PDF]</a></em></div>
        </li> 
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/issre_2016.pdf")}> [PDF]</a></em></div>
        </li> 
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/login_2015.pdf")}> [PDF]</a></em></div>
        </li>
        <li className="text-left li_padding_bottom">
            ...
            <a href={require("../Downloads/paper/hotos_2015.pdf")}> [PDF]</a></em></div>
        </li>
    </ol>
)
